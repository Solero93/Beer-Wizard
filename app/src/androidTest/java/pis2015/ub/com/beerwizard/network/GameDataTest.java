 ...
 */
public class GameDataTest extends Application {
    private static Handler spellsActivityHandler;
    private static String rule;
    private static UserTest user;
    ...
    public static void setSpellsActivityHandler(Handler spellsActivityHandler) {
        GameDataTest.spellsActivityHandler = spellsActivityHandler;
    }
     ...
     */
    public static UserTest getUser() {
        return user;
    }
    ...
    public static void setRule(String rule) {
        GameDataTest.rule = rule;
    }

    public void onCreate() {
        super.onCreate();
        SharedPreferences preferences = getSharedPreferences(ConstantsTest.SHARED_PREFERENCES_NAME, MODE_PRIVATE);
        // TODO String "Change me!" should go to strings.xml -> Put R.string.user_name_default instead of Change me! (and change to getInt)
        user = new UserTest(preferences.getString("name", "Change me!"), preferences.getInt("avatar", R.drawable.cara));
