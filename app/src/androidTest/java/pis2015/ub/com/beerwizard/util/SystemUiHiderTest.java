 ...
 * {@link #getInstance} will return a {@link SystemUiHiderHoneycombTest} instance,
 * while on older devices {@link #getInstance} will return a
 * {@link SystemUiHiderBaseTest} instance.
 * <p/>
 ...
 */
public abstract class SystemUiHiderTest {
    /**
    ...
    /**
     * Creates and returns an instance of {@link SystemUiHiderTest} that is
     * appropriate for this device. The object will be either a
     * {@link SystemUiHiderBaseTest} or {@link SystemUiHiderHoneycombTest} depending on
     * the device.
     *
     ...
     */
    public static SystemUiHiderTest getInstance(Activity activity, View anchorView, int flags) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            return new SystemUiHiderHoneycombTest(activity, anchorView, flags);
        } else {
            return new SystemUiHiderBaseTest(activity, anchorView, flags);
        }
    }

    protected SystemUiHiderTest(Activity activity, View anchorView, int flags) {
        mActivity = activity;
