...
/**
 * An API 11+ implementation of {@link SystemUiHiderTest}. Uses APIs available in
 * Honeycomb and later (specifically {@link View#setSystemUiVisibility(int)}) to
 * show and hide the system UI.
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public class SystemUiHiderHoneycombTest extends SystemUiHiderBaseTest {
    /**
     ...
     */
    protected SystemUiHiderHoneycombTest(Activity activity, View anchorView, int flags) {
