 ...
 */
public class UserTest implements UserInterface, BusObject {
     ...
     */
    public UserTest(String name, int avatarPhoto) {
        this.level = 1;
        this.name = name;
    ...
    public void levelUp() {
        ...
        Handler handler = GameDataTest.getSpellsActivityHandler();
        handler.sendMessage(handler.obtainMessage(ConstantsTest.MSG_LEVEL_UP));
    }
    ...
    public void levelDown() {
        ...
        Handler handler = GameDataTest.getSpellsActivityHandler();
        handler.sendMessage(handler.obtainMessage(ConstantsTest.MSG_LEVEL_DOWN));
    }
    ...
    public String getUUID() {
        return ConstantsTest.UUID_STRING;
    }
    ...
    public void acceptsLevelUp(String uuid) {
        Handler handler = GameDataTest.getSpellsActivityHandler();
        Message msg = handler.obtainMessage(ConstantsTest.MSG_DECIDE_LEVEL);
        msg.obj = uuid;
    ...
    public void castedSpell(int idSpell, String uuid, String param) {
        Handler handler = GameDataTest.getSpellsActivityHandler();
        Message msg = handler.obtainMessage(ConstantsTest.MSG_CASTED_SPELL);
    ...
    public void beJudge(String uuidCaster, String uuidVictim) {
        ...
        Message msg = h.obtainMessage(ConstantsTest.MSG_DECIDE_DUEL);
